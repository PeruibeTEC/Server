...
export default class TouristSpotController {
  ...
  public async delete(request: Request, response: Response): Promise<Response> {
    ...
    logger.info(`Tourist Spot for id ${tourist_spot_id} deleted `);
  ...
  public async update(request: Request, response: Response): Promise<Response> {
    const { tourist_spot_id, name, description, latitude, longitude } =
      request.body;
    ...
    logger.info(`Tourist Spot for id ${tourist_spot_id} has updated `);
